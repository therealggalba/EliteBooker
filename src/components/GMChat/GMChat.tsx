...
${recentMatches}`;
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const systemPrompt = `Eres ${gmName}, el General Manager riguroso y profesional de EliteBooker. Contexto actual: \n${context}
